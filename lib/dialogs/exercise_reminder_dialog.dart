            ...
            Expanded(
              child: ActivityGrid(
                ...
                onEditSequence: (sequence) async {
                  ...
                  if (existingSequence == null) {
                    print('Sequence not found in storage');
                    return;
                  }

                  // Get all available activities (excluding sequences)
                            ...
                            onSave: (updatedActivities) async {
                              ...
                              if (mounted) {
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                                    content: Text(
                                        'Sequence "${existingSequence.name}" updated'),
                                    backgroundColor: Colors.green,
                                    duration: const Duration(seconds: 2),
                                  ),
                                );
...
class _SequenceEditorDialog extends StatefulWidget {
  ...
  @override
  State<_SequenceEditorDialog> createState() => _SequenceEditorDialogState();
}

class _SequenceEditorDialogState extends State<_SequenceEditorDialog> {
